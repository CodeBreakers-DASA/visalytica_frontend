  ...
  return (
    <div className="bg-white dark:bg-noturno_medio_claro rounded-[10px] shadow-sm hover:shadow-md transition-shadow w-full min-h-[250px] flex flex-col">
      ...
      <div className="flex px-5 py-3 h-full">
        <div className="flex-1 flex flex-col justify-between pb-0 space-y-1.5 text-sm w-3/4">
        ...
        <div className="flex justify-center gap-2 pb-3 xs:pb-4 pt-2">
          <button
          ...
          <Popup
            classTrigger={
              "w-[35px] h-[35px] xs:w-[39px] xs:h-[39px] bg-vermelho text-white rounded-[8px] xs:rounded-[10px] hover:bg-red-700 transition-colors flex items-center justify-center"
            }
            paciente={paciente}
