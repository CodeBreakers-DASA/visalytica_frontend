...
export default function RelatorioMedicoPDF({ dados, configuracao = {} }) {
    ...
    const numeroRelatorio = `REL-${new Date().getFullYear()}-${String(Date.now()).slice(-6)}`
    ...
    const config = {
        ...
        medico: dados.medico.nome || 'Dr. João Silva', // Nome do médico logado exemplo
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    <View style={styles.logoContainer}>
                        ...
                        <View style={styles.logosRow}>
                            <Image src="/LogoVisalytica2.png" style={PDF_LAYOUT.logo.visalytica} />
                            <View style={styles.logoSeparator}></View>
                            <Image src="/LogoDasa.png" style={PDF_LAYOUT.logo.dasa} />
                        </View>
                        <View>
                            <Text style={styles.clinicInfo}>Av. Lins de Vasconcelos, 1222 - Aclimação, São Paulo - SP</Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.dadosContainer}>
                        <View style={styles.row}>
                            ...
                            <Text style={styles.value}>{dados.nomeAmostra || 'Não informado'}</Text>
                        </View>
                        ...
                        <View style={styles.assinaturaSection}>
                            ...
                            {dados?.imageUrls[0] && (
                                <View style={{ marginTop: 20 }}>
                                    ...
                                    <Image src={dados.imageUrls[0]} style={{ width: 200, height: 200 }} />
                                </View>
                            )}
                            ...
                            {dados?.imageUrls[1] && (
                                <View style={{ marginTop: 20 }}>
                                    ...
                                    <Image src={dados.imageUrls[1]} style={{ width: 200, height: 200 }} />
                                </View>
                            )}
                        </View>
                    )
                ...
                <View style={styles.footer}>
                    ...
                    <Text style={{ fontSize: PDF_FONTS.sizes.small, color: COLORS.textLight }}>
                        Relatório gerado automaticamente pelo sistema
                    </Text>
                    <Text style={{ fontSize: PDF_FONTS.sizes.small, color: COLORS.textLight }}>
                        Este documento é confidencial e destinado exclusivamente ao uso médico
                    </Text>
                    <Text style={{ fontSize: PDF_FONTS.sizes.small, color: COLORS.textLight }}>
