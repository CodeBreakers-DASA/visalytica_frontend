    ...
    return (
        <div className={`flex flex-row w-full justify-between items-center ${label ? 'gap-2 ' : ''} ${disabled && 'opacity-60'} ` + classDiv}>
            ...
            <input
                ...
                onChange={onChange}
                className={twMerge( 'w-full appearance-none bg-cinza_medio dark:bg-noturno_medio_claro  px-4 py-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-[15px] font-medium placeholder:text-cinza placeholder:text-[15px] placeholder:font-medium', inter.className,
